...
export function UserTableFilters({ filters, setFilters }: UserTableFiltersProps) {
  ...
  return (
    ...
    <div className="grid grid-cols-2 gap-2 md:flex md:flex-wrap md:items-center">
      ...
      <Input 
        placeholder="Nome" 
        className="h-8 col-span-2 md:w-[200px]" 
        value={filters.nome}
        onChange={(e) => setFilters(prev => ({ ...prev, nome: e.target.value }))}
      />
      ...
      <Button 
        ...
        size="sm" 
        type="button"
        className="h-8 col-span-2 md:col-auto bg-rose-500 text-white hover:bg-rose-600 hover:text-white"
        onClick={handleClearFilters}
      >
        Limpar Filtros
      </Button>
