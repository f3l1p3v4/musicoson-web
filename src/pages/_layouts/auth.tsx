...
export function AuthLayout() {
 ...
 <div className="grid min-h-screen grid-cols-1 md:grid-cols-2">
      ...
      <div
        className="hidden md:flex h-full flex-col justify-between border-r border-foreground/5 bg-muted p-10 text-muted-foreground"
      ...
      >
        ...
        <footer className="rounded bg-black px-1 text-sm text-white">
          Gestão para aula de música &copy; MusicosOn - {new Date().getFullYear()}
        </footer>
      </div>
